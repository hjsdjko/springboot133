...
public class ZhiyuanzhehuodongEntity<T> implements Serializable {
	...
	private String huodongtiaojian;
	 ...
	 * 设置：活动条件
	 */
	public void setHuodongtiaojian(String huodongtiaojian) {
		this.huodongtiaojian = huodongtiaojian;
	}
	/**
	 * 获取：活动条件
	 */
	public String getHuodongtiaojian() {
		return huodongtiaojian;
	}
	/**
	 * 设置：活动时间
	 */
